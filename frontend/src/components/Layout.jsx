        ...
        {auth && (
          <div className="border-b border-[#21262d] relative">
            ...
            <div className="flex items-center gap-2 px-4 py-2 mb-2">
              <code className="text-[#58a6ff] text-xs flex-1 truncate">pip install aga-ai-github-assistant</code>
              <button
                onClick={() => { navigator.clipboard.writeText('pip install aga-ai-github-assistant'); toast.success('Copied!') }}
